...
//该函数用于启用或禁用指定 AHB 外设设备的时钟。第一个参数 RCC_AHBPeriph 用于指定需要操作的外设设备，第二个参数 NewState 取值为 ENABLE 或 DISABLE，表示是否应启用或禁用该设备的时钟。
//该函数用于启用或禁用指定 APB2 外设设备的时钟。第一个参数 RCC_APB2Periph 用于指定需要操作的外设设备，第二个参数 NewState 取值为 ENABLE 或 DISABLE，表示是否应启用或禁用该设备的时钟。
//该函数用于启用或禁用指定 APB1 外设设备的时钟。第一个参数 RCC_APB1Periph 用于指定需要操作的外设设备，第二个参数 NewState 取值为 ENABLE 或 DISABLE，表示是否应启用或禁用该设备的时钟。
#ifdef STM32F10X_CL
